...
public:
	...
	void						applyLayerPattern(ConfigBase &config);
...
protected:
	...
	LayerRegion(Layer* layer, PrintRegion* region, std::vector<float> &slice_zs);
    ~LayerRegion() {}

private:
    Layer       *m_layer;
    PrintRegion *m_region;
	bool usePatternConfig = false;
	PrintRegionConfig patternConfig;
};
...
public:
    ...
    LayerRegion*            add_region(PrintRegion* print_region, std::vector<float> &slice_zs);
